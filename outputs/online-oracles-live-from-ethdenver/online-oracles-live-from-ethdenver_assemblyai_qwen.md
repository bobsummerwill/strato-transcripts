**[00:02] SPEAKER_00:** So, hello and welcome to DevCon 2026. So here recording for Early Days of Ethereum with Zoltán Palfalvi. How do you pronounce your name?

**[00:14] SPEAKER_01:** Zoltán Palfalvi.
...
**[03:05] SPEAKER_00:** And did you hear about it, you think, through, like through Danny and Viktor or some other way?

**[03:14] SPEAKER_01:** Well, I, I did hear about it from like Danny and Viktor's friend circle. So.

**[03:22] SPEAKER_00:** Right.

**[03:22] SPEAKER_01:** Yeah, but then Viktor was already. Actually, actually I never didn't know Viktor before. So I, I met. Heard about this thing through one of Danny's friends and then, then Viktor was also in that wider circle and he came to Hungary and said, oh, I'm already working on this. And then I, I started with my ideas and started to explain to him why this thing was probably will never work. And he was like, okay, you seem to have a good understanding of this. Why don't you come to work?
...
**[05:02] SPEAKER_00:** There you go. Yeah, I mean I, I think if I remember rightly that Viktor mentioned around May 2014 was when he first heard, you know, the trinity that this, this concept that you could have, you know, Ethereum as your sort of your compute and expensive database, Swarm as your decentralized storage and then Whisper as your messaging was that famous diagram, right, with the. There's like a circle and the things coming in and Whisper going around the edge and there's another one of those. But yeah, I mean, I guess it was Devcon 0 where Danny really presented a sort of a fleshed out vision of what that decentralized storage.

**[05:54] SPEAKER_01:** Yes, that's correct. I wasn't there at Devcon 0 yet. So I've heard about this idea even before I heard about Ethereum. So Danny Radeschi told me about this idea that he wants to do these kinds of hash based chunks storage and. Yeah, so it made total sense that he just pitched that.

**[06:14] SPEAKER_00:** That can fit in.

**[06:16] SPEAKER_01:** Yeah, at the time it was a perfect fit. Yeah. So he pitched this idea at Devcon 0 and, and when they accepted it and hired Danny, then he called me and said because he already knew that I know of this project and. Yeah, then let's do it together.

**[06:38] SPEAKER_00:** There you go. And then. So you were hired into EF? I did have a date for that. I've forgotten. I guess it was shortly after Devcon 0, right. That you started there?
...
**[11:01] SPEAKER_00:** Though he did have. Oh, ETH Labs was another one. Do you know anything about ETH Labs? Because when Jeff worked with JP Morgan to do Quorum, that was announced under the label EF Labs. Never heard of that.

**[11:18] SPEAKER_01:** Yeah, I think I heard the name, but I didn't really know what it does. But yeah, this is something I knew that Jeff started working with JP Morgan in that time. Big Banks really, really wanted to just talk to us at every Devcon and we were always invited to fancy dinners by some main people and so. So Vance really wanted to learn about the technology. So Jeff went for a while to work on Quorum. Yes.
...
**[22:53] SPEAKER_00:** So was that maybe the first time that you'd met a number of the people in Berlin like Christoph Jentzsch and Lefteris and maybe even Gavin?
...
**[23:41] SPEAKER_01:** I didn't go to any meetups to London before, but actually I, I did. So Viktor, Viktor was in London at the time and, and I was, I, I went to London around the time actually if you're doing some, some, some. Event with my old software company, the Hungarian software company.
...
**[24:17] SPEAKER_01:** And after that, yeah, I met up with Viktor and talked about Nice, yeah,

**[24:21] SPEAKER_00:** Ethereum related things because yeah, he, From what he was describing and then I was looking at videos and things later. He had seen Gavin talk in London in very, very early February, I think it was February 6th. So almost immediately after they'd had the Miami like you know, BTC Miami launch, you know, Vitalik's first public talk and, and the, you know, Anthony Di Iorio's like mansion where they, you know, a lot of them met for the first time. Gavin had been back in London, I think it was like a week, a week after and did a talk there that Viktor had gone to. That was Viktor's first, you know, in person meeting with any of these. And then you know, Gavin pulled him on board.

**[25:19] SPEAKER_01:** Yeah, so those are like the very early days I wasn't there. So when I first heard about Ethereum that was I think March or April 14. So, so I first heard about the pre sale and yeah, that's where I first heard about this thing. But yeah, I know that Gavin was one of the very early founders of this and he wrote the yellow paper full of Greek letters.
...
**[28:44] SPEAKER_01:** No, I wasn't. So Portal was Piper Merriam's brainchild. So by the time we kind of realized that LES was a nice first experiment, but maybe not the best approach, he started something different that was UDP based and also used different topologies. So it was kind of a DHT approach to storing the chain and the state. And yeah, actually I'm kind of, I think it's a bad thing that it, it's been completely canceled because actually to be honest, I never really believed that it will be an easily solvable problem to store the Merkle Patricia Trie of the state on DHT but for the chain data it made perfect sense. So yeah, maybe, maybe the state would have been possible with a lot of work. But yeah, I mean Piper told me of few times about how he imagines to solve all the unsolvable problems and I felt like yeah, it sounds good but he just made a lot of really hard assumptions about DHTs that by the time I already worked on Discovery V5, so there was also this discovery protocol that basically we designed it in 2016 in Berlin with Felix.
...
**[30:37] SPEAKER_01:** Especially with EIP-4444. So like, like that lets the snap protocol, the nodes processing snap protocol forget the blockchain history. So it made perfect sense to at least put the chain history on a DHT. But yeah, so it was an EF decision that it was discontinued at a point.
...
**[48:53] SPEAKER_00:** Yeah, I mean we had state channels and then we had plasma and then eventually coming into optimistic roll ups and then ZK later. Just many, many different attempts. Hello. See you sir.
