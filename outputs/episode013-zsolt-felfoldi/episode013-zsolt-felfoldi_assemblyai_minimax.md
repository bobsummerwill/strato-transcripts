**[00:02] SPEAKER_00:** So, hello and welcome to FDenver 2026. So here recording for Early Days of Ethereum with Zolt Felfeldy. How do you pronounce your name?

**[00:14] SPEAKER_01:** Zolt Zelfeldi.
...
**[05:54] SPEAKER_01:** Yes, that's correct. I wasn't there at DEVCON 0 yet. So I've heard about this idea even before I heard about Ethereum. So Danny Ryan told me about this idea that he wants to do these kinds of hash based chunks storage and. Yeah, so it made total sense that he just pitched that.
...
**[09:10] SPEAKER_01:** Yeah, so, so I like, like Jeff agreed that if, I mean, I bought my own plane ticket but I could stay at the Airbnb team stayed and yeah, I just worked with them and showed my contributions and yeah, so, so I, I, I, I, I went to Amsterdam unhired.
...
**[11:01] SPEAKER_00:** Though he did have. Oh, ETH Labs was another one. Do you know anything about ETH Labs? Because when Jeff worked with JPMorgan to do Quorum, that was announced under the label F Labs. Never heard of that.

**[11:18] SPEAKER_01:** Yeah, I think I heard the name, but I didn't really know what it does. But yeah, this is something I knew that Jeff started working with JPMorgan in that time big banks really, really wanted to just talk to us at every DEVCON and we were always invited to fancy dinners by some main people and so. So Viktor really wanted to learn about the technology. So Jeff went for a while to work on Quorum. Yes.

**[11:52] SPEAKER_00:** Yeah. I mean, unless I can somehow get in contact with Jeff. I guess it's a little bit of a mystery what exactly F Labs was. Though I suspect it might be a little bit like Ethersphere of just sort of being a name, a banner for activities rather than a legal entity. And another thing I don't know there, but I suspect is I don't think Jeff told Ming that he was doing that stuff with JPM. I suspect that he completely just did that on his own without any communication with Ming or with the EF. It's just he went and did it.

**[12:35] SPEAKER_01:** He never really told a lot to us about that. So we knew that. Yeah, he's working with JPMorgan, but probably it's a big thing. Probably he had to sign contracts on disclosure agreement, so just he probably couldn't share all the details.
...
**[22:53] SPEAKER_00:** So was that maybe the first time that you'd met a number of the people in Berlin like Christoph Jantz and Lefteris and maybe even Gavin?
...
**[23:41] SPEAKER_01:** I didn't go to any meetups to London before, but actually I I did. So Viktor, Viktor was in London at the time and, and I was, I, I, I went to London around the time actually if you're doing some, some, some. Event with my old software company, the Hungarian software company.
...
**[30:37] SPEAKER_01:** Especially with EIP 4444. So like, like that lets the snap protocol, the nodes processing snap protocol forget the chain history. So it made perfect sense to at least put the chain history on a DHT. But yeah, so it was an EF decision that it was discontinued at a point.
...
**[31:31] SPEAKER_01:** State 3 suffers from a lot of issues, especially in the Merkle Patricia Trie. Yeah and yeah, it's a huge data set that keeps changing all the time and keeps changing at completely random places and it's not as easy as task to distribute it. So actually it's getting harder to even synchronize it between full node storing the entire stuff.
