...
**[02:16] SPEAKER_03:** Got the moves. Let me just kick off. Hi. Hello, everybody. Uh, welcome, welcome. So we did it, we launched V2, it happened. How does that feel, man? I think Bob, you may not be as tired, you know. Oh, did, did, oh, he's gone away. Okay, he's frozen. He was filming. Yes, well.
...
**[03:16] SPEAKER_02:** Much better than before. You know, it's still— never— it's a funny thing. Do you ever feel good for like a sustained period? Like I think not. But uh, extremely happy that it's live. Um, I think it would be maybe interesting for the audience to go into a little bit of like what it is and also like why it took so long. So um, through the end of 2024, we started to realize that there was a lot of demand for DeFi type features. So basically, Marketplace version one, if you will, was more NFT-ish. We had interesting and exotic things that might be numbered and a breadth of them. So this was we have carbon offsets trading on their whiskey barrels. Michael moved a lot of collectible shoes through the system. So truly, you know, fairly unique, at least down to like having a serial number or sometimes very unique stuff. So there was occasional one-of-ones on there. We dipped our toes into the art market a little bit with some collabs. And also more financialized stuff, too. So the medals in particular being something that we've had for a long time. And we kind of saw— the most demand for the most financialized items. And it sort of led us to realize what people want from this technology. I mean, one way or another, I think in the course of the company, obviously we did very enterprise stuff, a lot in the supply chain, and that kind of actually led very naturally to the unique item focus. Um, and but you know often everything in the blockchain space pulls back to some sort of financialization and we kind of decided to stop resisting this impulse, you know, as the market seemed to be demanding it. So we released the other thing we realized is that um, in some ways, you know, say your goal is to tokenize everything, like you want all manner of real world value to be on chain existing uh alongside truly you know, digital native assets like Bitcoin, ETH and so on. What would get the world to do that? And we thought the answer was making liquid trading markets where they didn't exist prior. And that is definitely still part of it, but um, I think it is more about debt than it is about selling or transacting. Right. And so we kind of on Marketplace version one created a mechanism whereby you could borrow against collateral. It was sort of primitively done, but you could do it within the system and it got great uptake. And then we said, all right, let's just make this stuff a little more DeFi. And it just turned out that we were not expecting to do a relaunch. In fact, we were bringing folks on um through Q1 and Q2 and TVL was rising and you know etc, uh, more loan volumes and all that sort of thing. But we realized that we were hitting the limits of the system pretty quickly and that it would be just uh, you know, that we needed to at least change some of the way the internals worked and you know. So we did a listing of our gold token with a small exchange. It was a good experience to work with them, but they had a hard time dealing with things as they were, rather, and found that just everyone wants the ERC-20 style, and that to make the capabilities, you know, sort of show the best of DeFi, it was like a huge, huge effort that turned into a full relaunch, which was never the goal at the outset. You know, happy to be on the other side of it. The system is definitely way better. It's a little bit different. There are some areas where we kind of took a shortcut on version one that made it kind of easy, and we've gone and made it, say, more decentralized now, which is definitely better, but there could be like rough edges around it. As a for instance, we often had fixed pricing on Marketplace version one or pure spot pricing, and we have swap pools now, which is great in that they let the market determine the price and get third party liquidity in and so forth. But then there's just more variability on the any given trait execution uh, and so though these things will all sort of work themselves out over time um, but uh, huge effort, it's way better, way better. But it's— we ended up in more of a different place than I intended at the outset. Um, let me just let me throw it over to say Victor just on on all this.
...
**[19:12] SPEAKER_00:** The delays are not on the Strato side. It's pretty much instantaneous. It's on the, you know, Ethereum Sepolia side.
...
**[25:36] SPEAKER_01:** Yeah, we can always just repay it. And it will update here. Buy as remorse at instant and refund. Overall, that's the app. It's kind of a combination of Uniswap and Aave for you guys more familiar with Web3. If you guys have any questions or if you want a deeper walkthrough, feel free to message me on Telegram and we can hop on to Zoom.
...
**[26:39] SPEAKER_02:** I looked what there is— they're very small to the extent that they're out there.
...
**[28:28] SPEAKER_00:** And I was just going to add, like, if you want to try it out now, you can just go to our updated website at stratamercata.com and click launch app. One of the big efforts that we're going to is to improve the UX. So if anyone has any suggestions, please join our Telegram community and send us messages there. We'd love to hear from you. We're actively trying to improve it and, you know, achieve our goal of like mainstreaming DeFi.

**[28:59] SPEAKER_03:** And Colin there says, the whole platform works perfectly, just waiting on the rendering of the front page to be visible for me. That's a friend, Crypto Tarzan, who was having the issue of seeing his collateral that we're hiding under the non-earning assets.
...
**[30:23] SPEAKER_03:** At the end of the rainbow.
...
**[30:34] SPEAKER_00:** No, we just— we look forward to you guys trying it and giving us whatever input and we're really excited for you to see this and you know, we're still gonna evolve a lot. Um, things have been, uh, moving quickly and we'll continue to be moving quickly on it. So exciting times for us.

**[30:53] SPEAKER_03:** So, yeah, just to head to stratamercata.com. So, s-t-r-a-t-o-m-e-r-c-a-t-a.com. stratamercata.com. And you've got the app there and all the information.
