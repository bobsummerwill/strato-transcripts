...
**[00:55] SPEAKER_00:** That's right. So basically the deal there was that, I guess annually you had the king giving the speech in front of the Parliament, you know, so you had the royalty and all of the elite sitting in the hall. They were stuffing barrels of gunpowder underneath, but it was discovered at the last minute. So then there you go. You now have the burning of Guy Fawkes in effigy on Bonfire nights to celebrate that it didn't happen.

And yeah, so you have a doll or whatever that's the guy that you put on the fire. So, anyway, happy Bonfire Night, everybody.
...
**[02:09] SPEAKER_02:** Well, you work sales, you're a dev, you're a front end dev. You know, you do a bunch of different stuff on the team, so.
...
**[02:41] SPEAKER_02:** Oh, he's gone away. Okay. He's frozen. He was filming. Yes, well, there were a lot of sleepless nights and working weekends. Oh, you are back.
...
**[03:22] SPEAKER_01:** It's a funny thing. Do you ever feel good for a sustained period? Like I think not, but extremely happy that it's live. I think it would be maybe interesting for the audience to go into a little bit of what it is and also why it took so long.

So to the end of 2024 we started to realize that there was a lot of demand for DeFi type features. So basically Marketplace version 1, or Mercada version 1, if you will, was more NFT-ish. We had interesting and exotic things that might be numbered and a breadth of them. So this was, we have carbon offsets trading on there, whiskey barrels. Michael moved a lot of collectible shoes through the system. So truly, you know, fairly unique, at least down to having a serial number or sometimes very unique stuff. So there are occasional one of ones on there.

We dipped our toes into the art market a little bit with some collabs and also so. And then more financialized stuff too. So the metals in particular being something that we've had for a long time and we kind of saw the most demand for the most financialized items and it sort of led us to realize what people want from this technology. I mean, one way or another, you know, I think in the course of the company, obviously we did very enterprise stuff, a lot in the supply chain and that kind of actually led very naturally to the unique item focus. But you know, often everything in the blockchain space pulls back to some sort of financialization.

And we kind of decided to stop resisting this impulse, you know, as the market seemed to be demanding it. So we released the other thing we realized is that in some ways, so you know, say your goal is to tokenize everything. Like you want all manner of real world value to be on chain existing alongside truly digital native assets like Bitcoin and Eth. What would get the world to do that? And we thought the answer was making liquid trading markets where they didn't exist prior. And that is definitely still part of it. But I think it is more about debt than it is about selling or transacting.

Right. And so we kind of in Marketplace version 1 created a mechanism whereby you could borrow against collateral. It was sort of primitively done, but you could do it within the system. And it got great uptake. And then we, we said, all right, like let's just make this stuff a little more DeFi. And it just turned out that we were not expecting to do a relaunch. In fact, we were bringing folks on through Q1 and Q2 and TVL was rising and you know, etc. More loan volumes and all that sort of thing. But we realized that we were hitting the limits of the system pretty quickly and that it would be just, you know, that we needed to at least change some of the way the internals worked.

And you know, we, so we did a listing of our gold token with a small exchange. Was good experience to work with them, but they had, you know, a hard time dealing with things as, as they are, as they were rather and found that just everyone wants the ERC-20 style and that to make the capabilities, you know, sort of show the best of DeFi. It was like a huge, huge effort that turned into a full relaunch, which was never the goal at the outset, but you know, happy to be on the other side of it. The system is definitely way better. It's a little bit different. There are some areas where we kind of took a shortcut on version one that made it kind of easy and we've gone and made it say more decentralized now, which is definitely better.

But there, there could be like rough edges around it. As for instance, we often had fixed pricing on Marketplace version 1 or pure spot pricing. And we have swap pools now, which is great. And that they let the market determine the price and get third party liquidity in and so forth. But then there's just more variability on the, on the, any given trade execution. And so though these things will all sort of work themselves out over time, but huge effort, it's way better, way better. But it's, it's. We ended up in more of a different place than I intended at the outset.

Let me just, let me throw, throw it over to say Victor just on, on all this.
...
**[17:58] SPEAKER_03:** So we're going to start with bridging in tokens. There's two ways to do it. The normal bridge. Well first you have to connect your wallet of course using Metamask here. There's two ways to do it if you want to bridge an Eth or any kind of like wrap Bitcoin PAXG. I think we have something else forgot. But you bridge it in through this. If you want to bridge in stables I would go through the convert feature that will mint on bridge. So we're going to bridge in USDC. This is the testnet by the way. If you want to try it out, just go to this link. And if you want to get some test USDC AAVE has some test faucets for USDC and USDT but let's bridge in like 100 bucks maybe let's do USDC get USDT bridge it in. Confirm, confirm minting.

So I bridged them in before just because this is a bit of a process. But you could also check the status here takes a while for the. Takes a little bit for the server to update there. But visit earlier when I did that. Completed. So let's just assume that it's already in here.

**[19:20] SPEAKER_02:** We should be clear the delays are not on the Mercada side. Pretty much instantaneous. It's on the, you know, Ethereum Sepolia side.

**[19:28] SPEAKER_03:** Yep. So we're going to swap some right now. Let's swap some USDT. Let's do like I don't know, 10. Let's get some EST swap. And also gas is used through USDST on our app as well. Similar to, similar to HyperLiquid actually.
...
**[20:28] SPEAKER_00:** Vouchers just to clarify. So that's kind of a little, a little nice hack of getting past the. Oh my God, I haven't got any, any Ether for gas on this chain at this time.

**[20:44] SPEAKER_03:** Right, exactly.

**[20:46] SPEAKER_02:** It's a, it's a, it's an onboarding thing. Right. Like.

**[20:49] SPEAKER_00:** Yeah.

**[20:50] SPEAKER_02:** You know, the one big limitation on love chains, right. Like is you can't even do your first transactions on most of them until you have the native token. Right.
...
**[24:03] SPEAKER_01:** When you input to a swap pool you need to put in both pairs and we have, we have two modes here. It's probably just better to use the A and B mode but you can do a single sided liquidity ad. But what it does is it does a swap so that you have an equal amount of the other one and then it deposits it. So yeah and as long as the convenience if you.

**[24:27] SPEAKER_00:** If you wanted to get into it but you haven't got the right stuff.

**[24:30] SPEAKER_01:** That's correct.

**[24:31] SPEAKER_03:** Yeah yeah the buttons right here for everybody that wants to do it single side if they choose to do so. And let's see what are we going to. Let's do some borrowing. So I'm gonna supply my whole E stack 14 bucks all of it.
...
**[28:56] SPEAKER_00:** Mainstreaming DeFi and Colin there says the whole platform works perfectly. Just waiting on rendering of the front page to be visible. For me that's a friend. A friend crypto Tarzan who was having the. The issue of seeing his Carter that were hiding under the non earning assets.
...
**[29:55] SPEAKER_01:** I guess. Yeah, we should. Yeah, we should. I know some people have exited those. They are, no pun intended, kind of illiquid. But there's been a little bit of whiskey barrel trading so we should, we should discuss.
...
**[30:52] SPEAKER_00:** So yeah, just to head to stratomercada.com so S T R A T O M E R C A T A.com stratomercada.com and you've got the app there and all.
...
**[31:26] SPEAKER_00:** Well, don't I say if you, you know, if you, if you're, if you're not embarrassed a bit about the things that you release, then you release too late for sure.
