...
# ==============================================================================
# Step 7: SpeechBrain Installation
# ==============================================================================
echo -e "${YELLOW}[7/10] Installing SpeechBrain 1.1.0...${NC}"
echo "SpeechBrain 1.1.0 includes the torchaudio 2.9 compatibility fixes we previously monkey-patched."
pip install --upgrade "speechbrain==1.1.0"
echo -e "${GREEN}✓ SpeechBrain 1.1.0 installed${NC}"
echo ""
